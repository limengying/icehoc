...
public class SaiShiInfo {
	...
	public SaiShiInfo(int id, String competitionName, int teamAId, String clubAName, String clubALogo, int teamBId,
			...
			String address, String competitionDegreeName) {
		super();
		this.id = id;
		this.competitionName = competitionName;
		this.teamAId = teamAId;
	...
	public String toString() {
		return "SaiShiInfo [id=" + id + ", competitionName=" + competitionName + ", teamAId=" + teamAId + ", clubAName="
				...
				+ environmentalIndex + ", address=" + address + ", competitionDegreeName=" + competitionDegreeName
				+ "]";
	}
	public SaiShiInfo() {
		super();
