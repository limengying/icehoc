...
public class Team {
	...
	public Team(int teamId, String teamName, String teamLogo, String teamAddress, String buildTime, String telephone,
			String leaderName, String leaderTelephone, String construction, String email, String remark,
			String businessLicense, String idCardCopyFile, int checkId, int clubId) {
		super();
		this.teamId = teamId;
		this.teamName = teamName;
		this.teamLogo = teamLogo;
	...
	public String toString() {
		return "Team [teamId=" + teamId + ", teamName=" + teamName + ", teamLogo=" + teamLogo + ", teamAddress="
				+ teamAddress + ", buildTime=" + buildTime + ", telephone=" + telephone + ", leaderName=" + leaderName
				+ ", leaderTelephone=" + leaderTelephone + ", construction=" + construction + ", email=" + email
				+ ", remark=" + remark + ", businessLicense=" + businessLicense + ", idCardCopyFile=" + idCardCopyFile
				+ ", checkId=" + checkId + ", clubId=" + clubId + "]";
	}
