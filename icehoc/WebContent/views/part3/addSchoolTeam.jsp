		...
		<div data-role="content" class="content">
			<div class="content_div">
				...
				<div class="content_div_right">
					<input type="text" name="SchoolTeamName" class="SchoolTeamName"
						id="SchoolTeamName" data-role='none' />
				</div>
			</div>
			<div class="content_div">
			...
			<div class="content_div">
				...
				<div class="content_div_right">
					<textarea name="errorMain" id="schoolTeamConstruction"
						class="schoolTeamConstruction" placeholder="请简要说明">
               			 </textarea>
				</div>
			</div>
